...
TGeoCombiTrans matDemo_3(0., 0., 0., new TGeoRotation("rotDemo_3", 0., 20.3304, 0.));
...
TGeoCombiTrans matDemo_6(0., 0., 0., new TGeoRotation("rotDemo_6", 0., 20.3304, 0.));
/*
// EXAMPLE: S438B 
...
//  TGeoRotation *rotUni = new TGeoRotation();          //unitary rotation
  ...
  */
    ...
    // Volume: CBLogWorld
    TGeoVolume* pCBLogWorld = new TGeoVolume("CBLogWorld",pCBSphereWorld, pAirMedium);
...
//    top->AddNode(pCBLogWorld, 0, zeroRotTrans);
    ...
    // Volume: CBChamberLog
    TGeoVolume* pCBChamberLog = new TGeoVolume("CBChamberLog",pCBReactionChamber, pAlHousing);
    ...
    pWorld->AddNode(pCBChamberLog, 0, zeroRotTrans_1);
    ...
    TGeoVolume* pCBConicalTubeLog = new TGeoVolume("CBConicalTubeLog",pCBConicalTube, pAlHousing);
    pCBConicalTubeLog->SetVisLeaves(kTRUE);
    pCBConicalTubeLog->SetLineColor(33);
    pWorld->AddNode(pCBConicalTubeLog, 0, pCombTrans1);
    pWorld->AddNode(pCBConicalTubeLog, 1, pCombTrans2);
    pWorld->AddNode(pCBConicalTubeLog, 2, pCombTrans3);
